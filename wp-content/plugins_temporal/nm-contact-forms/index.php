	...
	function hideRow($type,$row){
		...
		switch($type){
			...
			case 'checkbox':
				...
				break;
			case 'html':
				if($row == 'extensions' || $row == 'size' || $row == 'placeholder' || $row == 'required' || $row == 'options' || $row == 'get' || $row == 'read_only') $hide = 'nm_hide';
				break;
			case 'radio':
				if($row == 'extensions' || $row == 'size' || $row == 'html' || $row == 'read_only') $hide = 'nm_hide';
				break;
		...
		foreach($nm_form['fields'] as $field){
			...
			switch($field['type']){
				case 'text':
					...
					$form.= '<input '.$read_only.' type="text" name="'.$field['slug'].'" placeholder="'.$field['placeholder'].'" value="'.$response['data'][$field['slug']].'"></li>';
					}else $form.= '<input '.$read_only.' type="text" name="'.$field['slug'].'" placeholder="'.$field['placeholder'].'" value="'.$get_value.'"></li>';
					break;
				case 'file_upload':
					$form.= '<li class="'.$field['classes'].'">';
				...
				case 'email':
					...
					if($nm_form['show_labels'] == 'on') $form.= '<div class="nm_label">'.$field['title'].'</div>';
					if(count($response['data'])){ 
					$form.= '<input '.$read_only.' type="email" name="'.$field['slug'].'" placeholder="'.$field['placeholder'].'" value="'.$response['data'][$field['slug']].'"></li>';
					}else $form.= '<input '.$read_only.' type="email" name="'.$field['slug'].'" placeholder="'.$field['placeholder'].'" value="'.$get_value.'"></li>';
					break;
				case 'radio':
				...
				case 'textarea':
					...
					if($nm_form['show_labels'] == 'on') $form.= '<div class="nm_label">'.$field['title'].'</div>';
					if(count($response['data'])){ 
					$form.= '<textarea '.$read_only.' name="'.$field['slug'].'" placeholder="'.$field['placeholder'].'">'.$response['data'][$field['slug']].'</textarea></li>';
					}else $form.= '<textarea  '.$read_only.' name="'.$field['slug'].'" placeholder="'.$field['placeholder'].'">'.$get_value.'</textarea></li>';
					break;
				case 'submit':
